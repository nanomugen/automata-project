...
FAZER UM SCRIPT COM JUMP COMMONS PARA COLOCAR TODA A LÓGICA DE JUMP QUE É COMUM ENTRE TODOS
OU FAZER UM COMMONS GERAL, PARA REAPROVEITAR CÓDIGO

A ANIMAÇÃO DE ATAQUE PRECISA DE UM TIMER, 
TALVEZ METADE DO TEMPO, ATÉ APARECER AREA2D DO ATAQUE E PODE CANCELAR
...
VER SE TEM ALGUMA FORMA DE FAZER UM OBJETO QUE VARIA O GRADIENTE
E FAZER UMA ANIMAÇÃO



HUD PRECISA SER GLOBAL?

MOVING PLATFORMS (TALVEZ FAZER UM OBJETO QUE MOVE DE UM LADO PRO OUTRO SÓ E COLOCAR UMA PLATAFORMA NISSO)

FADE IN/OUT FAZER EM UM NODE SEPARADO GLOBAL E S�O CHAMAR

PARTICLES E TEXTURES

ESPINHOS PRIMEIRO

SISTEMA DE DANO

CAMERA CSHAKE E MOVE FREEZE QUANDO TOMAR DANO

REMODELAR OS OBJETOS PARA FICAR MAIS INTUITIVO

REFAZER OS BOTÕES DE TECLADO

TEM ALGUMA COISA ERRADA COM A FONTE DOS TUTORIAIS

FAZER CADA STATE UMA SCENE SEPARADA? PODERIA REAPROVEITAR STATES
...
DONE
####################################################################################################
FAZER UMA GLOBAL SCENE DE TRANSIÇÃO? (PRA APAGAR A TELA E VOLTAR O JOGADOR NO LUGAR)
